...
var ElementToEntity = {
  a: function a(generator, tagName, element) {
    ...
    if (data.url != null) {
      return generator.createEntity(_draftJsUtils.ENTITY_TYPE.LINK, 'MUTABLE', data);
    }
  },
  img: function img(generator, tagName, element) {
    ...
    if (data.src != null) {
      return generator.createEntity(_draftJsUtils.ENTITY_TYPE.IMAGE, 'MUTABLE', data);
    }
  }
};
...
var ContentGenerator = function () {
  ...
  _createClass(ContentGenerator, [{
    ...
    key: 'createEntity',
    value: function createEntity(type, mutability, data) {
