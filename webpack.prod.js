...
//locale files
const localeFiles = walk('./src/')
  .filter(api=>/\.?locale\.js$/.test(api.path))
  .map(api=>api.path)
...
module.exports = merge(webpackCommon, {
  ...
  resolve: {
    alias: {
      ...
      'react-bootstrap': resolve(node_modules, 'react-bootstrap/dist/react-bootstrap.min.js'),
      ...
      'draft-js': resolve(node_modules, 'draft-js/dist/Draft.min.js'),
      'immutable': resolve(node_modules, 'immutable/dist/immutable.min.js'),
    }
  },
